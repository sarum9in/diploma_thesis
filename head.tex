...
%\renewcommand{\chapter}{\@startchapter{chapter}{1}%
%{\parindent}{3.25ex plus 1ex minus .2ex}%
%{1.5ex plus .2ex}{\bfseries\large\uppercase}}

\titleformat{\chapter}[hang]{\normalfont\Large\centering}{\thechapter.\ }{0pt}{\Large\uppercase}
%\titleformat{\section}[hang]{\normalfont\Large\centering}{\thesection.\ }{0pt}{\Large\uppercase}
